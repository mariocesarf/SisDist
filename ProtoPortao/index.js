...
let GateStatusMessageFactory = RequestRepository.lookupType("DispositivePackage.GateStatusMessage");
let EditGateStatusMessageFactory = RequestRepository.lookupType('DispositivePackage.EditGateStatusMessage');
...
tcpClient.on("data", (data) => {
  ...
  switch (Description) {
      case 'EditGateStatusMessage':
        ...
        let GateStatusMessage = GateStatusMessageFactory.encode(GateStatusMessageRequest).finish();
