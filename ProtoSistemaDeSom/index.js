...
let FeedbackMessageFactory = RequestRepository.lookupType(
  "DispositivePackage.FeedbackMessage"
);
let EditSoundSystemMessageFactory = RequestRepository.lookupType(
  "DispositivePackage.EditSoundSystemMessage"
);
...
tcpClient.on("data", (data) => {
  ...
  switch (Description) {
    case "EditSoundSystemMessage":
      ...
      VOLUME = Volume || 0;
      console.log(
        chalk.green(`A musica atual é ${ACTUAL_TRACK} com volume ${VOLUME}`)
      );
      ...
      let FeedbackMessage = FeedbackMessageFactory.encode(
